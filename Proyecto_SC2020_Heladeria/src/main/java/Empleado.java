...
public class Empleado {
    ...
    public Empleado(double salarioBruto, double planilla) {
    ...
    public void totalPlanilla() {
        ...
        JOptionPane.showMessageDialog(null, "La empresa Dulce Topic "
                + "tiene una inversión en planilla de ¢.: " + planilla);
    }
